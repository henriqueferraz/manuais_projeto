...
7. Se faltar detalhe no relato, peça informações específicas.
8. Se não houver evidência, diga explicitamente que não encontrou no manual.
9. Em caso de evidências conflitantes, apresente as duas versões em vez de escolher uma
   silenciosamente.
